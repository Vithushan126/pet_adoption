...
import Character from "../../assets/NotFound.jpg";
...
const NotFound = () => {
  ...
  return (
    <div className="flex flex-col h-full text-orange  justify-center items-center ">
      <div className="h-[100px] max-w-[1100px] flex items-center justify-between px-2 md:px-4   w-full">
        <img
          src={Logo}
          alt="Logo"
      ...
      <div className="flex flex-col items-center justify-between  h-full py-2">
        <div className="flex flex-col items-center justify-center space-y-2">
          <h1 className="text-2xl font-semibold ">Sorry, Page Not Found!</h1>
          <p className=" text-smokeGray text-center max-w-md ">
        ...
        <div className="flex flex-col items-center justify-center ">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#ff5a2f" />
                <stop offset="1" stopColor="#ff5a2f" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
